	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<h3 class="text-center bread-back">
				<?php
				echo "<a class=\"bread\" href=\"index.php\">Inicio</a> - Modificar técnico";
				?>
			</h3>
			<br>
			<form id="back-form" >
				...
				<tbody>
					<?php
						while($reg=mysqli_fetch_array($registrosTecnicos)){
							...
							echo "<tr>";							
								echo "<td class=\"minis-id\"> <a class=\"linksis\"  href=\"edit-tecnico.php?id_send=",urlencode($id_servicio)," \">$id_servicio</a> </td>"; 
