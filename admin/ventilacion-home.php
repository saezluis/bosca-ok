				...
				<div class="col-md-12">
					...
					<div class="btn-group">
						...
						<ul>
							<li>
								<?php
								echo "<a href=\"consultar-ventilacion.php\">Consultar productos</a>";
								?>
							</li>
							<li>
								<?php
								echo "<a href=\"agregar-ventilacion.php\">Agregar productos</a>";
								?>
							</li>							
							<li>
								<?php
								echo "<a href=\"modificar-ventilacion.php\">Modificar productos</a>";
								?>
							</li>
							<li>
								<?php
