		...
		<div class="row">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<?php
						echo "<a class=\"bread\" href=\"index.php\">Inicio</a> - <a class=\"bread\" href=\"cocina-home.php\">Tipo de producto: Cocinas y Calderas</a> - Eliminar producto";
					?>						
					</h3>
					<br>
					<form id="back-form" >						
						...
						while($reg=mysqli_fetch_array($registrosCocina)){
							...
							echo "<li class=\"briankeaton\">Nombre: $nombre  Modelo: $modelo  SKU: <a class=\"delete\" href=\"elim-cocina.php?id_send=",urlencode($id_cocina)," \">$sku</a> </li>";
							echo "<br>";
