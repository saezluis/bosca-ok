	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<?php			
				...
				echo "<span class=\"texto\"><input type=\"text\" value=\"Nombre:\" class=\"rightJustified\" readonly> <input type=\"text\" value=\"$nombre\"  name=\"nombre\" size=\"50\" readonly> </span>";		
				echo "<br>";
				echo "<span class=\"texto\"><input type=\"text\" value=\"Anexo nombre:\" class=\"rightJustified\" readonly> <input type=\"text\" value=\"$anexo_nombre\" name=\"anexo_nombre\" size=\"50\" readonly> </span>";		
				echo "<br>";
				echo "<span class=\"texto\"><input type=\"text\" value=\"Modelo:\" class=\"rightJustified\" readonly> <input type=\"text\" value=\"$modelo\" name=\"modelo\" size=\"50\" readonly> </span>";
				echo "<br>";
				echo "<span class=\"texto\"><input type=\"text\" value=\"SKU:\" class=\"rightJustified\" readonly> <input type=\"text\" value=\"$sku\" name=\"sku\" size=\"50\" readonly> </span>";		
				echo "<br>";
				echo "<span class=\"texto\"><input type=\"text\" value=\"Precio:\" class=\"rightJustified\" readonly> <input type=\"text\" value=\"$precio\" name=\"precio\" size=\"50\" readonly> </span>";		
				echo "<br>";
				
				echo "<span class=\"texto\"><input type=\"text\" value=\"Potencia:\" class=\"rightJustified\" readonly> <input type=\"text\" value=\"$potencia\" name=\"potencia\" size=\"50\" readonly> </span>";
				echo "<br>";
				echo "<span class=\"texto\"><input type=\"text\" value=\"Material:\" class=\"rightJustified\" readonly> <input type=\"text\" value=\"$material\" name=\"material\" size=\"50\" readonly> </span>";		
				echo "<br>";
				echo "<span class=\"texto\"><input type=\"text\" value=\"Número de quemadores:\" class=\"rightJustified\" readonly> <input type=\"text\" value=\"$nro_quemadores\" name=\"nro_quemadores\" size=\"50\" readonly> </span>";		
				echo "<br>";
				echo "<span class=\"texto\"><input type=\"text\" value=\"Alto:\" class=\"rightJustified\" readonly> <input type=\"text\" value=\"$alto\" name=\"alto\" size=\"50\" readonly> </span>";		
				echo "<br>";
				echo "<span class=\"texto\"><input type=\"text\" value=\"Ancho:\" class=\"rightJustified\" readonly> <input type=\"text\" value=\"$ancho\" name=\"ancho\" size=\"50\" readonly> </span>";		
				echo "<br>";
				
				echo "<span class=\"texto\"><input type=\"text\" value=\"Fondo tolva:\" class=\"rightJustified\" readonly> <input type=\"text\" value=\"$fondo_tolva\" name=\"fondo_tolva\" size=\"50\" readonly> </span>";		
				echo "<br>";
				echo "<span class=\"texto\"><input type=\"text\" value=\"Diametro Chimenea:\" class=\"rightJustified\" readonly> <input type=\"text\" value=\"$diametro_chimenea\" name=\"diametro_chimenea\" size=\"50\" readonly> </span>";		
				echo "<br>";
				...
				//echo "<br>";
				echo "<span class=\"texto\"><input type=\"text\" value=\"Consumo Pellet:\" class=\"rightJustified\" readonly> <textarea name=\"consumo_pellet\" rows=\"4\" cols=\"52\" readonly>$consumo_pellet</textarea> </span>";
				echo "<br>";
				...
				//echo "<br>";
				echo "<span class=\"texto\"><input type=\"text\" value=\"Capacidad Tolva:\" class=\"rightJustified\" readonly> <textarea name=\"capacidad_tolva\" rows=\"4\" cols=\"52\" readonly>$capacidad_tolva</textarea> </span>";
				echo "<br>";
				echo "<span class=\"texto\"><input type=\"text\" value=\"Volumen agua:\" class=\"rightJustified\" readonly> <input type=\"text\" value=\"$volumen_agua\" name=\"volumen_agua\" size=\"50\" readonly> </span>";		
				echo "<br>";
				echo "<span class=\"texto\"><input type=\"text\" value=\"Volumen carga:\" class=\"rightJustified\" readonly> <input type=\"text\" value=\"$volumen_carga\" name=\"volumen_carga\" size=\"50\" readonly> </span>";		
				echo "<br>";
				echo "<span class=\"texto\"><input type=\"text\" value=\"Longitud leña:\" class=\"rightJustified\" readonly> <input type=\"text\" value=\"$longitud_lena\" name=\"longitud_lena\" size=\"50\" readonly> </span>";		
				echo "<br>";
				echo "<br>";
