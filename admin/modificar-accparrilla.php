		...
		<div class="row">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<?php
						echo "<a class=\"bread\"  href=\"index.php\">Inicio</a> - <a class=\"bread\"  href=\"parrilla-home.php\">Tipo de producto: Accesorios Parrilla</a> - Modificar";
					?>						
					</h3>
					<br>		
					<form id="back-form" >			
						...
						while($reg=mysqli_fetch_array($registrosParrilla)){
							...
							echo "<li class=\"briankeaton\">Nombre: $nombre  Modelo: $modelo  SKU: <a class=\"linksis\"  href=\"edit-accparrilla.php?id_send=",urlencode($id_accparrilla)," \">$sku</a> </li>";
							echo "<br>";
