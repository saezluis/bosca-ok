					...
					<div class="row">
						...
						<form id="back-form">
							...
							<div class="cajaborder">
								...
								<span class="texto">Única resolución aceptada: <b>1200 x 385</b></span>
							...
							<?php
								...
								//$registrosBanners = mysqli_query($conexion,"select * from banners WHERE mostrar = 'si' ") or die("Problemas en el select:".mysqli_error($conexion));
